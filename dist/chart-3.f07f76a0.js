...
d3.csv(require('./data-multiline.csv')).then(ready).catch(function (err) {
...
function ready(datapoints) {
  ...
  svg.selectAll('path').data(nested).enter().append('path').attr('stroke', 'lightblue').attr('stroke-width', 2).attr('fill', 'none').attr('d', function (d) {
...
},{"d3":"../node_modules/d3/index.js","./data-multiline.csv":"data-multiline.csv"}],"../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","chart-3.js"], null)
//# sourceMappingURL=/chart-3.f07f76a0.map